...
for hand, bid in play:
    ...
    if count_j == 5:
        ...
        play[round_count].append(6)
    elif count_j == 3:
        play[round_count].append(4)
    elif count_j == 2:
        play[round_count].append(2)
    elif count_j == 1:
        play[round_count].append(1)


    for val, num_val in values:
        if num_val == 5 and val.lower() != "j":
            if len(play[round_count]) != 3:
                play[round_count].append(7)
        if num_val == 4 and val.lower() != "j":
            card_type = 6
            if len(play[round_count]) == 3:
                if play[round_count][2] < card_type and not count_j > 0:
                    play[round_count].pop(2)
                    play[round_count].append(card_type)
                elif play[round_count][2] < card_type and count_j == 1:
                    play[round_count].pop(2)
                    play[round_count].append(7)
            else:
                play[round_count].append(card_type)
        if num_val == 3 and val.lower() != "j":
            card_type = 4
            if len(play[round_count]) == 3:
                if play[round_count][2] < card_type and not play[round_count][2] == 2 and not count_j > 0:
                    play[round_count].pop(2)
                    play[round_count].append(card_type)
                elif play[round_count][2] == 2 and not count_j > 0:
                    play[round_count].pop(2)
                    play[round_count].append(5)
                elif count_j == 2 and play[round_count][2] < 7:
                    play[round_count].pop(2)
                    play[round_count].append(7)
                elif count_j == 1 and play[round_count][2] < 6:
                    play[round_count].pop(2)
                    play[round_count].append(6)
            else:
                play[round_count].append(card_type)
        if num_val == 2 and val.lower() != "j":
            card_type = 2
            if len(play[round_count]) == 3:
                if play[round_count][2] == 4 and not count_j > 0:
                    play[round_count].pop(2)
                    play[round_count].append(5)
                elif play[round_count][2] == card_type and not count_j > 0:
                    play[round_count].pop(2)
                    play[round_count].append(3)
                elif play[round_count][2] < card_type and not count_j > 0:
                    play[round_count].pop(2)
                    play[round_count].append(card_type)
                elif count_j == 3 and play[round_count][2] < 7:
                    play[round_count].pop(2)
                    play[round_count].append(7)
                elif count_j == 2 and play[round_count][2] < 6:
                    play[round_count].pop(2)
                    play[round_count].append(6)
                elif count_j == 1 and play[round_count][2] == 4 and play[round_count][2] < 5 :
                    play[round_count].pop(2)
                    play[round_count].append(5)
                elif count_j == 1 and play[round_count][2] < 4:
                    play[round_count].pop(2)
                    play[round_count].append(4)
            else:
                play[round_count].append(card_type)
        if num_val == 1 and val.lower() != "j":
            card_type = 1
            if len(play[round_count]) == 3:
                if play[round_count][2] < card_type and not count_j > 0:
                    continue
                elif play[round_count][2] < 2 and count_j == 1:
                    play[round_count].pop(2)
                    play[round_count].append(2)
                elif play[round_count][2] < 4 and count_j == 2:
                    play[round_count].pop(2)
                    play[round_count].append(4)
                elif play[round_count][2] < 6 and count_j == 3:
                    play[round_count].pop(2)
                    play[round_count].append(6)
                elif play[round_count][2] < 7 and count_j == 4:
                    play[round_count].pop(2)
                    play[round_count].append(7)
            else:
                play[round_count].append(card_type)
